    ...
    return (
        <div className="congrat-wrapper">
            ...
            <div className="congrat-main confetti-container">
                ...
                <h1>Chúc mừng!</h1>
                <p className='congrat-id'></p> {/**Nhập tên */}
                <p>Bạn đã nhận thành công <p className='congrat-score'></p>điểm</p> {/**Nhập điểm */}
                <a href="https://shbetv0.com/Promotion">
                    <button className="congrat-submit-btn" type="submit">Tiếp tục</button>
                </a>
            </div>  
        </div>
